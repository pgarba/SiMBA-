...
define i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #1 {
  ...
  %14 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str, ptr noundef nonnull @.str.2, i32 noundef %9, i32 noundef %10, i32 noundef %12)
  %15 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str, ptr noundef nonnull @.str.3, i32 noundef %9, i32 noundef %10, i32 noundef %12)
  ret i32 0
}
